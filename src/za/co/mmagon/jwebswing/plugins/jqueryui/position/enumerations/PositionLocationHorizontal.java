 ...
 */
package za.co.mmagon.jwebswing.plugins.jqueryui.position.enumerations;
...
public enum PositionLocationHorizontal
{
	...
	{
		return super.toString().toLowerCase().replace(StaticStrings.CHAR_UNDERSCORE, CHAR_SPACE);
	}
