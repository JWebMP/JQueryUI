 ...
 */
package za.co.mmagon.jwebswing.plugins.jqueryui.position.options;
 ...
 * @since 07 Apr 2013
 */
@ComponentInformation(name = "JQuery UI Position", description = "Position an element relative to the window, document, another element, " +
		                                                                 "" + "" + "" + "or the cursor/mouse.", url = "http://jqueryui.com/position/", wikiUrl = "https://github.com/GedMarc/JWebSwing-JQueryUIPlugin/wiki")
public class PositionOptions<J extends PositionOptions<J>> extends JavaScriptPart<J>
{
	 ...
	 * 		Of Which Component
	 */
	public PositionOptions(PositionLocationHorizontal myX, PositionLocationVertical myY, PositionLocationHorizontal atX,
	                       PositionLocationVertical atY, ComponentHierarchyBase of)
	{
		this.myY = myY;
		this.myX = myX;
		this.atX = atX;
