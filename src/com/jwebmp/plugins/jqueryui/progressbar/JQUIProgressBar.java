...
@ComponentInformation(name = "JQuery UI Progress Bar",
		description = "The progress bar is designed to display the current percent " + "complete for a process. The bar is coded to be flexibly " + "sized through CSS and will scale to fit inside its parent " + "container by default.",
