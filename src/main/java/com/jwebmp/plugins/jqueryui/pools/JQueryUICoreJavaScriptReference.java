 ...
 * @since 2014/12/09
 */
class JQueryUICoreJavaScriptReference
		extends JavascriptReference
{

	public JQueryUICoreJavaScriptReference()
	{
		super("JQueryUICore", 1.130,"bower_components/jquery-ui/jquery-ui.min.js", "https://ajax.googleapis.com/ajax/libs/jqueryui/1.13.0/jquery-ui.min.js");
		setSortOrder(5);
